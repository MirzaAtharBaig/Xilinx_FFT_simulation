...
#
# fft_sim.tcl: Tcl script for re-creating project 'fft_sim'
#
# Generated by Vivado on Fri Nov 08 18:50:41 PKT 2019
...
#
# 1. This project restoration tcl script (fft_sim.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/athar/Desktop/fft_sim/fft_sim.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "/home/athar/Desktop/fft_sim/fft_sim.srcs/sim_1/imports/fft_sim/tb_fft.v"
#
...
set orig_proj_dir "[file normalize "$origin_dir/fft_sim"]"
...
set files [list \
 [file normalize "${origin_dir}/fft_sim/fft_sim.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/fft_sim/fft_sim.srcs/sim_1/imports/fft_sim/tb_fft.v"]\
]
...
set_property -name "top" -value "tb_fft" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create ports
  set aclk_100M [ create_bd_port -dir I -type clk aclk_100M ]
  set m_axis_data_tuser_0 [ create_bd_port -dir O -from 15 -to 0 m_axis_data_tuser_0 ]
  set m_axis_data_tvalid_0 [ create_bd_port -dir O m_axis_data_tvalid_0 ]
  set sum [ create_bd_port -dir O -from 16 -to 0 -type data sum ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PINC1 {1101000110111011011010000000000000} \
  ...
  # Create instance: xlslice_i, and set properties
  set xlslice_i [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_i ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {16} \
  ...
  # Create instance: xlslice_q, and set properties
  set xlslice_q [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_q ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {15} \
   CONFIG.DIN_TO {8} \
   CONFIG.DIN_WIDTH {16} \
  ...
  connect_bd_net -net Net [get_bd_pins xfft_0/m_axis_data_tdata] [get_bd_pins xlslice_i/Din] [get_bd_pins xlslice_q/Din]
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_100M] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins xfft_0/aclk]
  connect_bd_net -net c_addsub_0_S [get_bd_ports sum] [get_bd_pins c_addsub_0/S]
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dds_compiler_0/m_axis_data_tdata] [get_bd_pins xfft_0/s_axis_data_tdata]
  connect_bd_net -net dds_compiler_0_m_axis_data_tvalid [get_bd_pins dds_compiler_0/m_axis_data_tvalid] [get_bd_pins xfft_0/s_axis_data_tvalid]
  ...
  connect_bd_net -net xfft_0_m_axis_data_tuser [get_bd_ports m_axis_data_tuser_0] [get_bd_pins xfft_0/m_axis_data_tuser]
  ...
  connect_bd_net -net xlslice_i_Dout [get_bd_pins mult_gen_0/A] [get_bd_pins mult_gen_0/B] [get_bd_pins xlslice_i/Dout]
  connect_bd_net -net xlslice_q_Dout [get_bd_pins mult_gen_1/A] [get_bd_pins mult_gen_1/B] [get_bd_pins xlslice_q/Dout]
...
#  -string -flagsOSRD
preplace port aclk_100M -pg 1 -lvl 0 -x 0 -y 490 -defaultsOSRD
preplace port m_axis_data_tvalid_0 -pg 1 -lvl 4 -x 1030 -y 520 -defaultsOSRD
preplace portBus m_axis_data_tuser_0 -pg 1 -lvl 4 -x 1030 -y 500 -defaultsOSRD
preplace portBus sum -pg 1 -lvl 4 -x 1030 -y 180 -defaultsOSRD
preplace inst c_addsub_0 -pg 1 -lvl 3 -x 780 -y 180 -defaultsOSRD
preplace inst dds_compiler_0 -pg 1 -lvl 2 -x 390 -y 490 -defaultsOSRD
preplace inst mult_gen_0 -pg 1 -lvl 2 -x 390 -y 70 -defaultsOSRD
preplace inst mult_gen_1 -pg 1 -lvl 2 -x 390 -y 190 -defaultsOSRD
preplace inst xfft_0 -pg 1 -lvl 3 -x 780 -y 530 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -x 780 -y 320 -defaultsOSRD
preplace inst xlslice_i -pg 1 -lvl 1 -x 130 -y 80 -defaultsOSRD
preplace inst xlslice_q -pg 1 -lvl 1 -x 130 -y 180 -defaultsOSRD
preplace netloc Net 1 0 4 20 260 NJ 260 NJ 260 1010
preplace netloc aclk_0_1 1 0 3 NJ 490 240 410 550J
preplace netloc c_addsub_0_S 1 3 1 NJ 180
preplace netloc dds_compiler_0_m_axis_data_tdata 1 2 1 560 490n
preplace netloc dds_compiler_0_m_axis_data_tvalid 1 2 1 540 510n
preplace netloc mult_gen_0_P 1 2 1 560J 70n
preplace netloc mult_gen_1_P 1 2 1 NJ 190
preplace netloc xfft_0_m_axis_data_tuser 1 3 1 1010J 490n
preplace netloc xfft_0_m_axis_data_tvalid 1 3 1 1000J 510n
preplace netloc xlconstant_0_dout 1 3 1 1000 320n
preplace netloc xlslice_i_Dout 1 1 1 240J 60n
preplace netloc xlslice_q_Dout 1 1 1 240J 180n
levelinfo -pg 1 0 130 390 780 1030
pagesize -pg 1 -db -bbox -sgen -130 0 1280 700
"
}
